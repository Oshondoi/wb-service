...
## Latest Session (Jan 25, 2026) - ✅ STICKY HEADERS + PROGRESS BAR + DEBT OPERATIONS REFACTOR

**🎯 CURRENT FOCUS**: Финализация визуальных улучшений и исправление логики работы с долгами.
...
- Теперь в БД хранятся ВСЕ операции с долгами (каждая начисление/погашение = отдельная строка)
- Старые записи, созданные по старой логике, будут отображаться корректно
- Новые записи создаются с отрицательными суммами для погашений
